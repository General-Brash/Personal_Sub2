...
describe('WechatPaymentCallbackView', () => {
  ...
  it('redirects back to the mall with an opaque resume token from hash fragment', async () => {
  ...
  it('redirects legacy openid callback payloads back to the mall while preserving resume context', async () => {
