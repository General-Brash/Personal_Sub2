  ...
  keys: {
    ...
    useKeyModal: {
      ...
      codexModelCatalog: {
        ...
        description: 'Fetch the current model manifest for this API key, then save it beside your Codex configuration.',
        fetch: 'Fetch catalog',
        retry: 'Retry fetch',
        download: 'Download JSON',
        modelsCount: '{count} models loaded',
        errorDescription: 'The catalog could not be fetched. Check the key, group, and gateway URL, then retry.',
      },
      openai: {
