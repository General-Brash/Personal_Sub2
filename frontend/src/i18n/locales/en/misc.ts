export default {
  ...
  payment: {
    ...
    purchaseCard: {
      expectedReceive: 'Expected benefit',
      expectedSpend: 'Estimated spend',
    },
    purchaseLimit: {
      ariaLabel: 'Product purchase limit progress',
      ...
      detail: '{scope}: {used}/{limit} purchased, {remaining} remaining',
      windowHint: 'Purchase limit window: {scope}',
    },
    purchaseConfirm: {
      ...
      remainingTitle: 'Purchases currently remaining',
      subscriptionReceive: '{validity} subscription access at ×{rate}',
    ...
    errors: {
      ...
      DAILY_PURCHASE_LIMIT_EXCEEDED: 'This product has reached its daily purchase limit',
      TOTAL_PURCHASE_LIMIT_EXCEEDED: 'This product has reached its lifetime purchase limit',
    ...
    admin: {
      ...
      benefitSub2: 'Sub2 Subscription Access',
      benefitDailyTemporaryCredit: 'Daily Temporary Credit',
      paymentCreditType: 'Payment Credit Type',
      dailyTemporaryCreditAmount: 'Temporary Credit Per Day',
      dailyTemporaryCreditAmountRequired: 'Daily temporary credit must be greater than 0.',
      dailyTemporaryCreditHint: 'Granted daily on Beijing time. Renewals extend expiry instead of stacking daily credit.',
      ...
      purchaseLimit: 'Purchase limit policy',
      periodicPurchaseLimit: 'Periodic limit per user',
      totalPurchaseLimit: 'Lifetime limit per user',
      purchaseLimitPlaceholder: '0 (unlimited)',
      periodicPurchaseLimitHint: 'Enter 0 or leave blank for unlimited. The unit and refresh mode below define the period.',
      totalPurchaseLimitHint: 'Maximum historical purchases per user. Enter 0 or leave blank for unlimited.',
      purchaseLimitUnit: 'Limit unit',
      purchaseLimitUnitDay: 'Day',
      purchaseLimitUnitWeek: 'Week',
      purchaseLimitUnitMonth: 'Month',
      purchaseLimitMode: 'Refresh mode',
      purchaseLimitModeCalendar: 'Natural period',
      purchaseLimitModeRolling: 'Rolling window',
      purchaseLimitWindowSize: 'Rolling length',
      purchaseLimitWindowSizeHint: 'Combines with the unit, for example 3 days, 2 weeks, or 4 months.',
      purchaseLimitCalendarHint: 'Natural periods are always one selected unit.',
      purchaseLimitSummary: '{scope}: {limit} per user',
      purchaseLimitInvalid: 'Purchase limits must be whole numbers greater than or equal to 0.',
      purchaseLimitWindowSizeInvalid: 'Rolling length must be a whole number greater than 0.',
