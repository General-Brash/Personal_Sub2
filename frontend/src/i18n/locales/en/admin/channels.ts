export default {
    ...
    riskControl: {
      ...
      secondaryReviewModelVersion: 'Review Model Version',
      secondaryReviewTraceId: 'Trace ID',
      secondaryReviewMode: 'Review Mode',
      secondaryReviewFallback: 'Fallback Action',
      secondaryReviewModeValues: {
        off: 'Off',
        shadow: 'Shadow',
        enforce: 'Enforce',
      },
      secondaryReviewFallbackValues: {
        none: 'None',
        keyword_block: 'Block by keyword',
      ...
      action: {
        ...
        intentAllow: 'Secondary review allowed',
        intentReview: 'Secondary review flagged',
        intentBlock: 'Secondary review blocked',
        intentShadow: 'Secondary review shadow record',
        intentError: 'Secondary review error allowed',
        intentErrorBlock: 'Secondary review error blocked',
        error: 'Error',
      },
    },
