export default {
    ops: {
      ...
      settings: {
        ...
        retentionDaysHint: 'Recommended 7-90 days; longer periods consume more storage. Set to 0 to disable automatic cleanup for that target',
        ...
        validation: {
          title: 'Please fix the following issues',
          retentionDaysRange: 'Retention days must be between 0 and 365 (0 = automatic cleanup disabled)',
          slaMinPercentRange: 'SLA minimum percentage must be between 0 and 100',
          ttftP99MaxRange: 'TTFT P99 maximum must be a number ≥ 0',
          requestErrorRateMaxRange: 'Request error rate maximum must be between 0 and 100',
          upstreamErrorRateMaxRange: 'Upstream error rate maximum must be between 0 and 100',
      ...
      cleanup: {
        ...
        entryHint: 'Configure retention policies and run previewed, audited manual cleanup',
        loadFailed: 'Failed to load cleanup configuration',
        retry: 'Retry',
        saveSuccess: 'Automatic cleanup policies saved',
        saveFailed: 'Failed to save automatic cleanup policies',
        automaticTitle: 'Automatic cleanup',
        automaticHint: 'Each category is independent. Zero disables retention and never wipes a table. Audit logs continue to use their existing retention worker.',
        schedule: 'Schedule (Cron)',
        cronHint: 'Use a standard five-field Cron expression, for example 0 2 * * *.',
        cronInvalid: 'Enter a valid five-field Cron expression.',
        auditRetention: 'Admin audit retention days (0 = keep forever)',
        manualTitle: 'Manual cleanup',
        category: 'Data category',
        mode: 'Scope',
        rangeMode: 'Date range',
        allMode: 'Entire table (dangerous)',
        startDate: 'Start date',
        endDate: 'End date (exclusive)',
        preview: 'Preview',
        previewRows: '{count} rows can be deleted',
        blockedRows: '{count} rows are protected by relationships',
        rangeRequired: 'Select a start and end date',
        previewFailed: 'Cleanup preview failed',
        sensitiveHint: 'This category contains sensitive financial or security records. Confirmation text and a fresh TOTP are required.',
        confirmation: 'Enter confirmation text: {value}',
        totp: 'Six-digit TOTP code',
        execute: 'Run cleanup',
        executeSuccess: 'Cleanup request submitted',
        executePending: 'Cleanup task queued. Track its progress in the audit list.',
        executeFailed: 'Cleanup failed',
        auditTitle: 'Cleanup audit',
        auditLoadFailed: 'Failed to load cleanup audits',
        auditPending: 'A cleanup task is queued or running. This list will refresh automatically.',
        auditTime: 'Time',
        operator: 'Operator',
        status: 'Status',
        deletedRows: 'Actually deleted',
        rowCounts: 'Preview / protected / deleted',
        rowCountValues: '{preview} / {blocked} / {deleted}',
        taskId: 'Task ID',
        error: 'Failure reason',
        targets: {
          opsErrorLogs: 'Ops error logs',
          opsAlertEvents: 'Ops alert events',
          opsSystemLogs: 'Ops system logs',
          opsCleanupAudits: 'System-log cleanup audits',
          opsSystemMetrics: 'Minute system metrics',
          opsMetricsHourly: 'Hourly aggregate metrics',
          opsMetricsDaily: 'Daily aggregate metrics',
          usageLogs: 'Site-wide usage ledger',
          auditLogs: 'Admin audit logs',
          mallPurchases: 'Mall transactions',
          paymentOrders: 'Payment orders',
          bankLedger: 'Bank transaction log'
        }
      },
      concurrency: {
