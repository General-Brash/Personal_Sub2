export default {
    ...
    groups: {
      ...
      form: {
        ...
        maxReasoningEffortOverLimitHint: 'Applies after a ceiling is set. Downgrade rewrites values above the ceiling to the ceiling. Deny rejects the request.',        reasoningEffortMappings: 'Reasoning effort mappings',
        ...
        reasoningEffortModelPlaceholder: 'Empty = all / gpt / gpt-5.4',        addReasoningEffortMapping: 'Add mapping',
        ...
        duplicateScope: 'Type and model combination must be unique',        duplicateFrom: 'Request value A must be unique',
