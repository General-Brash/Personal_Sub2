export default {
    ...
    riskControl: {
      ...
      secondaryReviewModelVersion: '二审模型版本',
      secondaryReviewTraceId: '追踪号',
      secondaryReviewMode: '二审模式',
      secondaryReviewFallback: '降级动作',
      ...
      action: {
        ...
        intentReview: '二次审核复核',
        intentBlock: '二次审核拦截',
        intentShadow: '二次审核影子记录',
        intentError: '二次审核异常放行',
        intentErrorBlock: '二次审核异常拦截',
        error: '异常',
      },
    },
