...
function validateIntervalPrices(iv: IntervalFormEntry, idx: number, t: TranslateFn): string | null {
  ...
  const multipliers: [string, number | string | null][] = [
    ['inputMultiplier', iv.input_multiplier ?? null],
    ['outputMultiplier', iv.output_multiplier ?? null],
    ['cacheWriteMultiplier', iv.cache_write_multiplier ?? null],
    ['cacheReadMultiplier', iv.cache_read_multiplier ?? null],
  ]
