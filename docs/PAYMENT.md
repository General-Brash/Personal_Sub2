...
>
> Provider details can change. Verify current API compatibility, settlement rules, fees, availability, security, and compliance requirements directly with the provider. This project does not endorse or guarantee any third-party payment provider.
