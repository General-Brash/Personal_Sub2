...
Personal_Sub2 是基于官方 `v0.1.169` 代码基线开发并独立维护的开源软件。任何基于 Personal_Sub2 进行的自部署、二次开发、托管运行、对外服务、商业化使用、用户管理、内容处理、数据处理、支付结算、客户支持及上游账号或接口使用行为，均由相应实例的部署、运营或控制主体自行负责。
