...
const (
	...
	// ContextKeyTokenVersion 认证中间件写入的当前 JWT 认证 epoch。
...
var auditActionOverrides = map[string]string{
	...
	"POST /api/v1/admin/oidc-provider/clients":                              "oidc.client.create",
	"PUT /api/v1/admin/oidc-provider/clients/:id":                           "oidc.client.update",
	"POST /api/v1/admin/oidc-provider/clients/:id/secrets":                  "oidc.client.secret.rotate",
	"POST /api/v1/admin/oidc-provider/clients/:id/secrets/:secretID/revoke": "oidc.client.secret.revoke",
	"POST /api/v1/admin/oidc-provider/clients/:id/disable":                  "oidc.client.disable",
	"POST /api/v1/admin/oidc-provider/clients/:id/enable":                   "oidc.client.enable",
	"POST /api/v1/admin/oidc-provider/consents/:id/revoke":                  "oidc.consent.revoke",
	"POST /api/v1/admin/oidc-provider/keys/rotate":                          "oidc.key.rotate",
	"POST /api/v1/admin/oidc-provider/keys/:kid/retire":                     "oidc.key.retire",
	"POST /api/v1/admin/oidc-provider/keys/:kid/revoke":                     "oidc.key.revoke",
}
