...
func RegisterAdminRoutes(
	...
	RegisterOIDCProviderAdminRoutes(admin, h, stepUpAuth)
	{
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		// OpenAI pool API-key health breaker (default disabled)
		adminSettings.GET("/openai-api-key-health", h.Admin.Setting.GetOpenAIAPIKeyHealthBreakerSettings)
		adminSettings.PUT("/openai-api-key-health", h.Admin.Setting.UpdateOpenAIAPIKeyHealthBreakerSettings)
		// 面板 API 限流配置
