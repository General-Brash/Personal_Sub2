...
func (p ChannelModelPricing) Clone() ChannelModelPricing {
	...
	if p.TimePricing != nil {
		cp.TimePricing = &ChannelTimePricing{Timezone: p.TimePricing.Timezone, WeekdaysOnly: p.TimePricing.WeekdaysOnly}
...
func validateIntervalPrices(iv *PricingInterval, idx int) error {
	prices := []struct {
		...
		{"cache_write_price", iv.CacheWritePrice}, {"cache_write_1h_price", iv.CacheWrite1hPrice},
		{"cache_read_price", iv.CacheReadPrice}, {"per_request_price", iv.PerRequestPrice},
	}
