...
func TestUpdateServiceComparesPersonalReleaseChannel(t *testing.T) {
	tests := []struct {
		...
		{name: "P1 updates to P2", current: "v0.1.6-P1", latest: "v0.1.6-P2", want: -1},
		{name: "P1 patch updates to P2", current: "v0.1.6-P1.2", latest: "v0.1.6-P2", want: -1},
		{name: "P2 is up to date", current: "v0.1.6-P2", latest: "v0.1.6-P2", want: 0},
