...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/General-Brash/Personal_Sub2/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/General-Brash/Personal_Sub2/blob/main/docs/legal/admin-compliance.en.md"
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 Personal_Sub2 部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the Personal_Sub2 Deployment and Operation Compliance Commitment"
