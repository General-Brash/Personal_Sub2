...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyQuickJumpEnabled:                          "false",
		SettingKeyQuickJumpItems:                            "[]",
		SettingKeyOIDCConsentPromptMode:                     OIDCConsentPromptModeAlways,
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result := &SystemSettings{
		...
		OIDCConsentPromptMode:                  normalizeOIDCConsentPromptMode(settings[SettingKeyOIDCConsentPromptMode]),
