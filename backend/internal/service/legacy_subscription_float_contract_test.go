...
func requireLegacySubscriptionFloat64(float64) {}

func requireLegacySubscriptionUsageRecorder(func(*SubscriptionService, context.Context, int64, float64) error) {
}
...
func TestLegacySubscriptionUsageBoundaryRemainsFloat64(t *testing.T) {
	...
	requireLegacySubscriptionFloat64(subscription.DailyUsageUSD)
	var _ legacySubscriptionUsagePort = (UserSubscriptionRepository)(nil)
	requireLegacySubscriptionUsageRecorder((*SubscriptionService).RecordUsage)
}
