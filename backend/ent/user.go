...
type UserEdges struct {
	...
	// TemporaryCreditGrants holds the value of the temporary_credit_grants edge.
...
// TemporaryCreditGrantsOrErr returns the TemporaryCreditGrants value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) TemporaryCreditGrantsOrErr() ([]*TemporaryCreditGrant, error) {
	if e.loadedTypes[14] {
		return e.TemporaryCreditGrants, nil
	}
	return nil, &NotLoadedError{edge: "temporary_credit_grants"}
}

// GrantedTemporaryCreditGrantsOrErr returns the GrantedTemporaryCreditGrants value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) GrantedTemporaryCreditGrantsOrErr() ([]*TemporaryCreditGrant, error) {
	if e.loadedTypes[15] {
		return e.GrantedTemporaryCreditGrants, nil
	}
...
// QueryTemporaryCreditGrants queries the "temporary_credit_grants" edge of the User entity.
func (_m *User) QueryTemporaryCreditGrants() *TemporaryCreditGrantQuery {
	return NewUserClient(_m.config).QueryTemporaryCreditGrants(_m)
}
