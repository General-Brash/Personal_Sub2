...
// was not loaded in eager-loading.
func (e GroupEdges) BatchImageCreditHoldsOrErr() ([]*BatchImageCreditHold, error) {
	if e.loadedTypes[4] {
...
// QueryBatchImageCreditHolds queries the "batch_image_credit_holds" edge of the Group entity.
func (_m *Group) QueryBatchImageCreditHolds() *BatchImageCreditHoldQuery {
	return NewGroupClient(_m.config).QueryBatchImageCreditHolds(_m)
}
