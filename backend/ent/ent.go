...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			affiliaterebatejob.Table:             affiliaterebatejob.ValidColumn,
			announcement.Table:                   announcement.ValidColumn,
			announcementread.Table:               announcementread.ValidColumn,
			authidentity.Table:                   authidentity.ValidColumn,
			authidentitychannel.Table:            authidentitychannel.ValidColumn,
			batchimagecredithold.Table:           batchimagecredithold.ValidColumn,
			batchimagecreditholdallocation.Table: batchimagecreditholdallocation.ValidColumn,
			...
			temporarycreditconsumption.Table:     temporarycreditconsumption.ValidColumn,
			temporarycreditgrant.Table:           temporarycreditgrant.ValidColumn,
