...
func (*SubscriptionPlan) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case subscriptionplan.FieldPrice, subscriptionplan.FieldOriginalPrice, subscriptionplan.FieldDailyTemporaryCreditAmount:
			values[i] = new(sql.NullFloat64)
		case subscriptionplan.FieldID, subscriptionplan.FieldGroupID, subscriptionplan.FieldValidityDays, subscriptionplan.FieldSortOrder, subscriptionplan.FieldDailyPurchaseLimit, subscriptionplan.FieldTotalPurchaseLimit, subscriptionplan.FieldPurchaseLimitWindowSize:
			values[i] = new(sql.NullInt64)
		case subscriptionplan.FieldName, subscriptionplan.FieldDescription, subscriptionplan.FieldBenefitType, subscriptionplan.FieldPaymentCreditType, subscriptionplan.FieldCurrency, subscriptionplan.FieldValidityUnit, subscriptionplan.FieldFeatures, subscriptionplan.FieldProductName, subscriptionplan.FieldPurchaseLimitUnit, subscriptionplan.FieldPurchaseLimitMode:
...
func (_m *SubscriptionPlan) String() string {
	...
	builder.WriteString(_m.BenefitType)
	builder.WriteString(", ")
	...
	builder.WriteString(fmt.Sprintf("%v", _m.DailyTemporaryCreditAmount))
	builder.WriteString(", ")
