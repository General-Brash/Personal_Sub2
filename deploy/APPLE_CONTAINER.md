# Personal_Sub2 Apple container Deployment

Personal_Sub2 can run as a native three-service stack with Apple's `container` CLI. This workflow runs the published Personal_Sub2, PostgreSQL, and Redis OCI images without Docker Desktop or a Docker-compatible daemon.
