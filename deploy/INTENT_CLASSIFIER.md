...
- Release image: `ghcr.io/general-brash/personal_sub2-intent-classifier:v0.1.183-P1`
...
IMAGE="${INTENT_CLASSIFIER_IMAGE:-ghcr.io/general-brash/personal_sub2-intent-classifier:v0.1.183-P1}"
...
$Image = 'ghcr.io/general-brash/personal_sub2-intent-classifier:v0.1.183-P1'
